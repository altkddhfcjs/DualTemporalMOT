...
def init_distributed_mode(args):
    ...
    torch.distributed.init_process_group(backend=args.dist_backend, timeout=timedelta(seconds=5400))

    # torch.distributed.init_process_group(backend="nccl", init_method="env://", timeout=timedelta(seconds=18000), world_size=args.world_size, rank=args.rank)
