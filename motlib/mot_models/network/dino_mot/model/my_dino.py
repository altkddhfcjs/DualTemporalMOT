...
class MyDINO(DINO):
    ...
    def forward_encoder(self, samples):
        ...
        if not self.training and not self.disable_timer:
        ...
        memory, mask_flatten, spatial_shapes, lvl_pos_embed_flatten, level_start_index, valid_ratios, bs = self.transformer.forward_encoder(
            srcs, masks, poss)
