...
class MotDeformableTransformer(DeformableTransformer):
    ...
    def init_decoder_layer(self, args, num_decoder_layers, d_model, dim_feedforward,
        ...
        MotDeformableTransformerDecoderLayer(
            ...
            key_aware_type=key_aware_type, decoder_sa_type=decoder_sa_type, module_seq=module_seq, train_enc=self.train_enc) for layer_id in range(num_decoder_layers)])
    ...
    def forward(self,
                memory, mask_flatten, spatial_shapes, lvl_pos_embed_flatten, level_start_index, valid_ratios, bs, refpoint_embed,
                tgt, attn_mask=None, track_instances=None):
        ...
        # Begin Decoder
        #########################################################
        hs, references, track_dec_out, offset, weight = self.decoder(
